...
const SmartTools = () => {
    return (
        <section className="relative py-16  text-gray-800 overflow-hidden">
            {/* Header */}
            ...
            <div className="relative flex justify-center items-center h-[900px]">
                ...
                <div className="absolute top-0 left-0 w-full h-full flex justify-center items-center">
                    ...
                    <div className="top-0 left-0 w-full h-full flex justify-center items-center ">
                        ...
                        <div
                            className="absolute left-1/2 top-1/2 w-3 h-3  rounded-full border border-black"
                            style={{ transform: "rotate(-130deg) translateX(357px)" }}
                        ></div>

                        {/* Top-right dot (Stress-Free Budgeting) */}
                        <div
                            className="absolute left-1/2 top-1/2 w-3 h-3 border border-black rounded-full"
